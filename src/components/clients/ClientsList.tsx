...
export function ClientsList({ initialClients, initialPrograms, initialHasMore, initialCursor }: ClientsListProps) {
  ...
  // Fetch clients when status filter changes (server-side filter)
  const fetchClientsWithFilter = useCallback(async () => {
        ...
        <main className="container px-4 py-6">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
            ...
            <div className="flex gap-2">
              <Button variant="outline" onClick={fetchClientsWithFilter} disabled={isPending}>
